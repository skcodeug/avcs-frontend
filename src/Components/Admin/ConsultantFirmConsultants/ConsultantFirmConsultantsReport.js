...
class ConsultantFirmsConsultantsReport extends React.Component {
  constructor() {
    super();
    this.state = {
      data: [],
  ...
  fetchData = () => {
    axios
      .get("https://avcs-platform.herokuapp.com/consultantFirmConsultants", {
        headers: {
          Authorization:
...
export default ConsultantFirmsConsultantsReport;
