...
class AnnualLeaveDepartmentReport extends React.Component {
  constructor() {
    super();
    this.state = {
      data: [],
  ...
  fetchData = () => {
    axios
      .get("https://avcs-platform.herokuapp.com/annualLeaveDepartments", {
        headers: {
          Authorization:
...
export default AnnualLeaveDepartmentReport;
