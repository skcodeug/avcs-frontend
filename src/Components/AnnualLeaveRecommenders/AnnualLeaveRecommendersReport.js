...
class AnnualLeaveRecommendersReport extends React.Component {
  constructor() {
    super();
    this.state = {
      data: [],
  ...
  fetchData = () => {
    axios
      .get("https://avcs-platform.herokuapp.com/annualLeaveRecommenders", {
        headers: {
          Authorization:
...
export default AnnualLeaveRecommendersReport;
