...
class ConsultantFirmsReport extends React.Component {
  constructor() {
    super();
    this.state = {
      data: [],
  ...
  fetchData = () => {
    axios
      .get("https://avcs-platform.herokuapp.com/consultantFirms", {
        headers: {
          Authorization:
...
export default ConsultantFirmsReport;
