...
function Hr() {
    ...
    const findFormErrors = () => {
        ...
        if (!maritalStatus || maritalStatus === "")
            newErrors.maritalStatus = "Choose your maarital status!";

        // recruitmentDate errors
        if (!recruitmentDate || recruitmentDate === "")
            newErrors.recruitmentDate = "Choose a recruitment date!";
        ...
        if (!position || position === "")
            newErrors.position = "Enter employee position!";

        // consultancyRate errors
        if (!consultancyRate || consultancyRate === "")
            newErrors.consultancyRate = "Enter your Rate!";
        ...
        if (!transcript || transcript === "")
            newErrors.transcript = "Attach Academic Triscript!";
